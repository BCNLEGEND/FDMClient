...
const winners2022 = (props) => {
  ...
  return (
    <>
      <Head>
        <title>
          Guanyadors del Concurs Fotogràfic 2022 » Farmàcia del mar »
          Arenys de Mar
        </title>
        <meta
          name="description"
          content="Guayadors al 4rt concurs fotogràfic de la Farmàcia del Mar."
        />
        <meta
