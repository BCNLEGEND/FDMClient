    ...
    <Paper className={classes.container}>
      <div style={{ color: 'var(--primary-color)' }}>
        ...
        <p>
          ...
          relativos al tratamiento de datos de los diferentes usuarios que
          navegan o facilitan sus datos personales a través de los diferentes
        ...
        <p>
          ...
          proporcione a través de cualquier de las redes sociales de las cuales
          el usuario está registrado. En este caso, la privacidad dependerá de
          la propia configuración establecida por el usuario, así como de los
          términos y condiciones de la propia red social.
        </p>
        <p>
          La visita del usuario a la web no implica que tenga que facilitar
          ninguna información sobre sus datos personales. No obstante, en caso
          de facilitarlos, los datos serán tratados de forma lícita con sujeción
          en todo momento a los principios y derechos recogidos en el RGPD
          2016/679 de 27 de abril de 2016 y la LOPDGDD 3/2018 del 5 de
          diciembre.
        </p>
        <p>&nbsp;</p>
        ...
        <p>
          ...
          Responsable que actúan como encargados del tratamiento.
        </p>
        <p>
        ...
        <p>
          ...
          datos de forma lícita, que ha informado previamente a los afectados,
          obteniendo su consentimiento para comunicarlos y que la información
          facilitada es exacta y veraz.
        </p>
        <p>
          <strong>Carácter obligatorio de la información solicitada</strong>
        </p>
        <p>
        ...
        <p>
          ...
          el formulario de registro de acuerdo a las reglas de complejidad que
          se establezcan en cada momento en la web.
        </p>
        <p>
          Los usuarios son responsables de la adecuada custodia y
          confidencialidad de cualesquiera de los identificadores y/o
          contraseñas que hayan seleccionado en el registro, y se comprometen a
          no ceder su uso a terceros, ni permitir su acceso a personas ajenas.
        </p>
        <p>
          ...
          acceso no autorizado a los mismos, con el fin de proceder a su
        ...
        <p>
          ...
          tratamiento. Tiene derecho a actualizarlos y solicitar la
          rectificación de los datos que sean inexactos o solicitar la supresión
          cuando los datos no sean necesarios para los fines para los que fueron
          recabados. Puede solicitar la limitación en el tratamiento de sus
          datos y oponerse al tratamiento de los mismos revocando su
          consentimiento, así como ejercer el derecho a la portabilidad de los
          datos. Del mismo modo, tiene derecho a no ser objeto de decisiones
          basadas únicamente en el tratamiento automatizado de sus datos
          personales. Puede ejercer sus derechos contactando con nosotros C.
          d'Avall, 18; 08350 Arenys de Mar (Barcelona). Email:{' '}
        ...
        <p>
          ...
          el acceso y uso del portal a menores de dicha edad. Si en algún
          momento, el Responsable detecta que un menor de 14 años ha
          proporcionado datos de carácter personal, procederemos a la
          cancelación de los mismos. Asimismo, los padres o tutores podrán en
          cualquier caso dirigirse a Silvia Ametlla Pallì para bloquear la
          cuenta de acceso de los menores a su cargo que se hubieran registrado
        ...
        <p>
          ...
          que desarrolla nuestra organización. Estas herramientas almacenan
          datos personales en los servidores de los servicios respectivos y se
          rigen por su propia política de privacidad. Se recomienda la revisión
          y la lectura de las condiciones de uso y política de privacidad de la
          red social en el momento de registrarse, teniendo en cuenta las
          diferentes posibilidades de configuración en relación al grado de
          privacidad del perfil de usuario en la red social.
        </p>
        <p>
          Asimismo, el Responsable se reserva el derecho de eliminar de sus
          redes sociales cualquier información publicada por terceros que
          vulnere la legalidad, incite a hacerlo o contenga mensajes que atenten
          contra la dignidad de personas o instituciones. Como también el
        ...
        <p>
          ...
          permiten a la web, entre otras cosas, almacenar y recuperar
          información sobre los hábitos de navegación del usuario o de su equipo
