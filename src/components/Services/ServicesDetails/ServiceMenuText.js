const text = {
  ...
  es: {
    ...
    consells: {
      title: 'Consejos',
      text:
        'Siempre damos el mejor consejo de cualquier terapia anterior y también del consejo dietético y nutricional, que complementados, ayudan y acompañan a mejorar tu salud, con un proyecto de vida para conseguir que te sientas bien con tu cuerpo, tu mente, y tu entorno. Todas las terapias integrativas que aplicamos van focalizadas para lograr estar "siempre cerca de ti" y obtener: + salud, + bienestar, + confort emocional, para ser + feliz.',
      img: 'service05.jpg',
    },
  },
  en: {
    ...
    consells: {
      title: 'Advise',
      text:
        'We always give the best advice from any previous therapy and also dietary and nutritional advice, which complement, help and accompany to improve your health, with a life project to make you feel good with your body, your mind, and your environment. All the integrative therapies we apply are focused on being “always close to you” and obtaining: + health, + well-being, + emotional comfort, to be + happy.',
      img: 'service05.jpg',
    },
  },
};
